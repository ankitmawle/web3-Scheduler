...
library Address {
     ...
     * ====
     */
    function isContract1(address account) internal view returns (bool) {
    ...
    function functionCallWithValue(
        ...
        require(isContract1(target), "Address: call to non-contract");
    ...
    function functionStaticCall(
        ...
        require(isContract1(target), "Address: static call to non-contract");
    ...
    function functionDelegateCall(
        ...
        require(isContract1(target), "Address: delegate call to non-contract");
